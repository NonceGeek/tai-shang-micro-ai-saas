module MicroAISaas::MicroAISaasTable {
    ...
    struct MicroAISaas has key, store,copy {
        id: u64,
    ...
    public fun get_task(account: &signer, id: u64): option::Option<MicroAISaas> acquires MicroAISaasTable {
